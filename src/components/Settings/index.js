...
import StyleSettings, {SettingsItemControl, StyledSettingsGroup, StyledSettingsItem} from "./style";
import PropTypes, {func} from 'prop-types';
import Paragraph from "../Paragraph";
import Switch from "../Switch";
import Icon from "../Icon";
import {ReactComponent as ArrowMenuRight} from "../../asserts/icons/arrowMenuRight.svg"
    ...
    return (
        <StyleSettings {...rest}>
            <SettingsGroup groupName={"隐私设置"}>
                ...
                <SettingsItem
                    label={"推荐通讯录好友"}
                    description={"上传的通讯录只用来匹配好友列表，本应用不会记录和发送任何信息给其他机构或组织"}
                />
